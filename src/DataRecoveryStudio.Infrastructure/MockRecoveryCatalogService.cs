...
public sealed class MockRecoveryCatalogService : IRecoveryCatalogService
{
    public async Task<IReadOnlyList<RecoverableFile>> GetResultsAsync(ScanSession session, CancellationToken cancellationToken)
    {
        ...
        [
            ...
            File("family-video.mp4", @"Users\Avery\Videos\", 824_633_720, now.AddMonths(-2), FileCategory.Video, RecoverabilityStatus.Poor, source, "Video preview placeholder · MPEG-4 video · 14:32"),
            ...
            File("RECOVERED_000124.bin", @"Deep Scan\Unknown\", 65_536, null, FileCategory.Unknown, RecoverabilityStatus.Unknown, source, "Preview unavailable · file type is unknown"),
            ...
            File("holiday-clip.mov", @"Users\Avery\Videos\Trips\", 283_951_104, now.AddMonths(-5), FileCategory.Video, RecoverabilityStatus.Poor, source, "Video preview placeholder · QuickTime video · 03:46"),
    ...
    private static RecoverableFile File(
        ...
        string preview) => new(Guid.NewGuid(), name, path, size, modified, category, status, source, preview);
}
